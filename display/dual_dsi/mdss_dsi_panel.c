			...
			struct mdss_dsi_ctrl_pdata *ctrl_pdata)
{
	...
	if (pinfo->is_dba_panel) {
		...
		/*added by mickey.shi, 2017/2/8*/
		{
			enum resolution_index {
				MIPI_1280x720P60_16_9_ZZW500HAH = 108,
				MIPI_1920x1080P60_16_9_ZZW550QAQ,
				MIPI_1920x1080P60_16_9_JM55FH,
			};

			data = of_get_property(np, "qcom,dsi-resolution", NULL);
			if (data) {
				if (!strcmp(data, "1280x720p60@zzw500hah"))
					ctrl_pdata->resolution = MIPI_1280x720P60_16_9_ZZW500HAH;
				else if (!strcmp(data, "1920x1080p60@zzw550qaq"))
					ctrl_pdata->resolution = MIPI_1920x1080P60_16_9_ZZW550QAQ;
				else if (!strcmp(data, "1920x1080p60@jm55fh"))
					ctrl_pdata->resolution = MIPI_1920x1080P60_16_9_JM55FH;
				else
					ctrl_pdata->resolution = 0;
			} else
				ctrl_pdata->resolution = 0;
		}
	}
