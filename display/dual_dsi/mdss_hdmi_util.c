	...
	struct msm_hdmi_mode_timing_info *mode, int id)
{
	...
	case HDMI_VFRMT_3840x2160p60_64_27:
		...
		break;
	case MIPI_VFRMT_1280x720p60_16_9_ZZW500HAH:
		MSM_HDMI_MODES_GET_DETAILS(mode, MIPI_VFRMT_1280x720p60_16_9_ZZW500HAH);
		break;
	case MIPI_VFRMT_1920x1080p60_16_9_ZZW550QAQ:
		MSM_HDMI_MODES_GET_DETAILS(mode, MIPI_VFRMT_1920x1080p60_16_9_ZZW550QAQ);
		break;
	case MIPI_VFRMT_1920x1080p60_16_9_JM55FH:
		MSM_HDMI_MODES_GET_DETAILS(mode, MIPI_VFRMT_1920x1080p60_16_9_JM55FH);
		break;
	default:
