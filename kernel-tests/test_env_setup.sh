################################################################################
# Copyright (c) 2009-2011,2013-2016 Qualcomm Technologies, Inc.  All Rights Reserved.
...
# TARGET_TYPE = {7X27 | 7X30 | 8650 | 8650A | 8660 | 8960 | 9615 | 8916 | MSM8917 | MSM8920 |8939 | 8936 | msm8994/8994 | 8909 | 8952 | 8929 | 8976 | 8956 | mdm9607  | mdmcalifornium | 8937 | 8953 | MSMCOBALT | MSMFALCON}
...
target_lists="76XXT- 7X27 7X30 8650B 8650D 8660 8960 9x15 8974 9x25 8x10 8910 8610 8226 8x26 8926 8026 8084 msmsamarium 8x62 8916 MSM8917 MSM8920 8939 8936 8092 msmkrypton 9x35 msm8994 9640 8909 8952 8992 8929 8996 8976 8956 mdm9607 mdmcalifornium 8937 8953 MSMCOBALT"
...
do
	...
	target_name="8937"
        ...
        target_name="8953"
    elif [ "$i" = "MSMFALCON" ];then
	target_name="falcon"
    elif [ "$i" = "MSMCOBALT" ];then
	target_name="cobalt"
    elif [ "$i" = "mdm9607" ]; then
	target_name="mdm9607"
