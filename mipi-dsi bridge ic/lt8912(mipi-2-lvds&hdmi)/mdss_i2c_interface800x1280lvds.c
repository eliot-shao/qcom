...
// 设置LVDS屏的CLK：
	#define Panel_Pixel_CLK	 7200 /*//8040	// 65MHz * 100*/
...
//	{1024,	600,	1344,	635,	140,	20, 	3,	20};// 1024x600 Timing
	{800,	1280,	920,	1304,	24,		24, 	2,	10};// 1024x800 Timing
...
static int MIPI_Timing[]  = {800,	1280,	920,	1304,	24,		24, 	2,	10};// 1024x720 Timing
...
//***********************************************************//
	...
	//printk(KERN_ERR "eliot 0x6c = 0x%x,0x6b = 0x%x \n",0x80 + Core_PLL_Ratio.Temp8[1],Core_PLL_Ratio.Temp8[0]);
//***********************************************************//
//------------------------------------------//
...
//***********************************************************//
	...
	//printk(KERN_ERR "eliot 0x8f = 0x%x,0x90 = 0x%x \n",Core_PLL_Ratio.Temp8[0],Core_PLL_Ratio.Temp8[1]);
//***********************************************************//
...
//***********************************************************//
	...
	// 注意大小端，此处为小端模式（Little-endian） 
	HDMI_WriteI2C_Byte(0x91,Core_PLL_Ratio.Temp8[0]);
	HDMI_WriteI2C_Byte(0x92,Core_PLL_Ratio.Temp8[1]);
	//printk(KERN_ERR "eliot 0x91 = 0x%x,0x92 = 0x%x \n",Core_PLL_Ratio.Temp8[1],Core_PLL_Ratio.Temp8[0]);
//***********************************************************//
